...
def get_clean_factor_and_forward_returns(factor,
    ...
    for period in periods:
        ...
        mask_return_period.fillna(value=True, inplace=True)  # no return data, just like suspended, we drop them
        mask_return = np.logical_or(mask_return, mask_return_period)
